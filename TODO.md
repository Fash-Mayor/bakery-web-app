...
## Todo
- A section to ask peps what to do to improve site; justa collapsable section that can be taken up and down, it writesthe feedback into a file and sends it to...(more on that) (spreadsheet?)✅ 
- Sends as mail to me.✅
- Home page UI up.✅
- footer✅
- Reloding clears the cart✅
- Review summary of the order about to be placed✅
- Add "Shop" that contains: Cakes, Pasteries, Bread sections✅
- Add similar products in productpage✅
- Add"when do you want it delivered?" to the checkout ✅
- UI of Categories in the cart page✅
