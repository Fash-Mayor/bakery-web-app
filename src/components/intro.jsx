...
const Intro = ({ onEnter }) => {
  ...
  return (
    <div
      {...handlers}
      className="intro-slider max-w-7xl mx-auto px-4 flex flex-col items-center justify-center h-screen"
    >
      <div className="slider1 max-w-90 flex flex-col justify-center mb-34">
        <img src={slides[slide].image} alt={slides[slide].title} />
        <p className="text-xl sm:text-3xl font-semibold flex justify-center my-5">
          {slides[slide].title}
        </p>
        <p className="mx-auto max-w-85 text-lg text-gray-700 flex justify-center text-center">
          {slides[slide].text}
        </p>
